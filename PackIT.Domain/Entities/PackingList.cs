...
namespace PackIT.Domain.Entities
{
    ...
    public class PackingList : AggregateRoot<PackingListId>
    {
        ...
        internal PackingList(PackingListId id, PackingListName name, Localization localization) // Primitive obsesion "string name, string localization"
        {
            Id = id;
            _name = name;
        ...
        //internal PackingList(PackingListId id, PackingListName name, PackingListLocalization localization, LinkedList<PackingItem> items)
